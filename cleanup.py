...
def cleanup(NREPEAT, NCORES, ITR, RAPL, DVFS, FLINKRATE, BUFFTIMEOUT):
    ...
    for core in range(0, NCORES):
        ...
        print(f"flink {NREPEAT} {ITR} {DVFS} {RAPL} {latency} {np.around(tjoules, 2)} {trx_desc} {trx_bytes} {ttx_desc} {ttx_bytes} {tins} {trefcyc} {tnum_interrupts} {final_latency}",file=sys.stdout)
