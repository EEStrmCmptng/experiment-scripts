...
op0_busy = pd.read_csv(loc+'/Flinklogs/Operator_Mapper_0',delimiter=';', header = None, skiprows=15, chunksize=30)
...
print(op0_busy_mean)
op1_busy = pd.read_csv(loc+'/Flinklogs/Operator_Mapper_1',delimiter=';', header = None, skiprows=15, chunksize=30)
...
src_back = pd.read_csv(loc+'/Flinklogs/Operator_Source: Bids Source_0',delimiter=';', header = None, skiprows=15, chunksize=30)
...
snk_busy = pd.read_csv(loc+'/Flinklogs/Operator_Latency Sink_0',delimiter=';', header = None, skiprows=15, chunksize=30)
